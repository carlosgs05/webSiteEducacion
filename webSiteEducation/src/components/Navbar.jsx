  ...
  return (
    <nav
      className={`fixed inset-x-0 top-0 z-50 transform transition-transform duration-300
        ${
          scrolled
            ? "bg-[#303030]/40 backdrop-blur-md shadow-lg"
            : "bg-[#303030]/20 backdrop-blur-sm"
        }
        translate-y-0`}
    >
        ...
        <ul className="hidden lg:flex space-x-8 text-white font-medium items-center">
          {enlaces.map((it) => (
            <li key={it.href}>
              <Link
                to={it.href}
                className="relative py-2 hover:text-purple-600 group"
              >
                {it.label}
          ...
          <li
            className="relative"
            onMouseEnter={() => setHoverNov(true)}
            onMouseLeave={() => setHoverNov(false)}
          >
          ...
          <li
            className="relative"
            onMouseEnter={() => setHoverServ(true)}
            onMouseLeave={() => setHoverServ(false)}
          >
            <button className="flex items-center space-x-1 py-2">
            ...
            {hoverServ && (
              <div className="absolute top-full bg-white/90 backdrop-blur-sm shadow-lg rounded-lg w-48 text-gray-800">
                <ul className="py-2">
                  <li>
                    <Link
                      to="/serviciosAdministrativos/mesa-de-partes"
                      className="block px-4 py-2 hover:bg-gray-100"
                    >
                      Mesa de partes
                    </Link>
                  ...
                  <li>
                    <Link
                      to="/serviciosAdministrativos/documentos-tramites"
                      className="block px-4 py-2 hover:bg-gray-100"
                    >
                      Documentación
                    </Link>
