...
const Sidebar = ({ isOpen = true, toggle = () => {} }) => {
  ...
  return (
    ...
    >
      {/* Branding */}
      <div className="flex items-center px-5 py-4 border-b border-gray-600">
        <div className="bg-gradient-to-br from-[#E4BCD3] to-[#d8a1c3] rounded-xl p-1 shadow">
          <div className="bg-gray-800 w-9 h-9 rounded-lg flex items-center justify-center">
            <span className="text-[#E4BCD3] font-bold text-lg">U</span>
          </div>
        </div>
        <div className="ml-3">
          <h1 className="text-lg font-bold bg-gradient-to-r from-[#E4BCD3] to-[#d8a1c3] bg-clip-text text-transparent">
            Escuela Inicial
          </h1>
          <p className="text-xs text-gray-300 mt-0.5">Panel Administrativo</p>
        </div>
        <button
      ...
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        <div className="relative">
          ...
          {openDropdown === "organizacion" && (
            <div className="mt-1 ml-8 space-y-1 border-l-2 border-gray-600 pl-3">
              <button
                onClick={() =>
        ...
        <button
          ...
          className={`w-full flex items-center px-3 py-2.5 rounded-xl transition-all text-left text-sm cursor-pointer group ${
            noticiasMatch ? "bg-[#E4BCD3] text-[#545454]" : "hover:bg-gray-700"
          }`}
        >
          <div
            className={`rounded-lg p-1.5 transition-colors ${
